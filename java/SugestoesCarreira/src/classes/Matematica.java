...
public class Matematica extends Materia{
	...
	public void imprimirListaSugestoes() {
		if (engajamento() == 'B' || engajamento() == 'b') {
			...
			System.out.println("1 - Engenharia         (X)");
			System.out.println("2 - Docência           (X)");
			System.out.println("3 - Comércio Exterior  (X)");
			System.out.println("4 - Gestão Financeira  (X)");
			System.out.println("5 - Economia           (X)");
			...
			System.out.println("Lista de sugestões a seguir nesta área: ");
			System.out.println("1 - Engenharia         ( )");
			System.out.println("2 - Docência           ( )");
			System.out.println("3 - Comércio Exterior  ( )");
	...
	public void opcao() {
		...
		if (op == '1') {
			...
			System.out.println("Docência: \n"
					+"O professor de Matemática pode atuar em escolas de ensino fundamental e médio. \n"
